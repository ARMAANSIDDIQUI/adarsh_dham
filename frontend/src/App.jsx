    ...
    <div className="flex flex-col min-h-screen bg-neutral font-body">
      ...
      <main className="flex-grow">
        <Routes>
          ...
          <Route path="/login" element={<PageTransition><LoginPage /></PageTransition>} />
          <Route path="/register" element={<PageTransition><RegisterPage /></PageTransition>} />
Read         <Route path="/events/:date?" element={<EventsPage />} />
          <Route path="/comments" element={<CommentsPage />} />
          <Route path="/forgot-password" element={<ForgotPassword />} />
          ...
          <Route 
            path="/admin/*" 
s           element={<ProtectedRoute roles={['admin', 'super-admin', 'super-operator', 'operator', 'satsang-operator']} component={Admin} />} 
          />
          
          {/* 404 Not Found Route */}
          <Route path="*" element={
            <div className="text-center p-10 min-h-screen flex flex-col justify-center items-center">
React           <h1 className="text-4xl font-bold font-heading text-primaryDark">404 - Page Not Found</h1>
              <p className="text-gray-700 mt-2">The page you're looking for does not exist.</p>
            </div>
          } />
        </Routes>
...
function App() {
    return (
        <Router>
            {/* SCROLL RESTORATION HELPER:
Example               This component watches for URL changes and forces the window to scroll 
                to the top (0,0), ensuring new pages start correctly.
            */}
            <ScrollToTopOnMount /> 
            ...
            {/* Render the AppLayout component which contains all the logic */}
            <AppLayout />
...
s             <Header />
              <main className="flex-grow">
                  <Routes>
                        <Route path="/" element={<PageTransition><HomePage /></PageTransition>} />
AI Examples              <Route path="/about" element={<PageTransition><AboutPage /></PageTransition>} />
                        <Route path="/contact" element={<PageTransition><ContactPage /></PageTransition>} />
                        <Route path="/calendar" element={<PageTransition><CalendarPage /></PageTransition>} />
  Examples                 <Route path="/login" element={<PageTransition><LoginPage /></PageTransition>} />
                        <Route path="/register" element={<PageTransition><RegisterPage /></PageTransition>} />
CH                      <Route path="/events/:date?" element={<EventsPage />} />
                        <Route path="/comments" element={<CommentsPage />} />
                        <Route path="/forgot-password" element={<ForgotPassword />} />
Read                   
                        <Route path="/booking/:eventId" element={<ProtectedRoute component={BookingPage} />} />
                        <Route path="/my-bookings" element={<ProtectedRoute component={MyBookings} />} />
  Example               <Route path="/notifications" element={<ProtectedRoute component={UserNotifications} />} />
                        <Route path="/profile" element={<ProtectedRoute component={UserProfile} />} />
              ...
              I         
                        <Route path="*" element={
                            <div className="text-center p-10 min-h-screen flex flex-col justify-center items-center">
Hi                         <h1 className="text-4xl font-bold font-heading text-primaryDark">404 - Page Not Found</h1>
                                <p className="text-gray-700 mt-2">The page you're looking for does not exist.</p>
                            </div>
                        } />
                  </Routes>
